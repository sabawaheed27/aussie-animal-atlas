function Animal (name, lifespan, group, food, description, length, weight, found, image, icon, isActive) {
    this.name=name;
...
const ytbCockatoo= new Animal (
    ...
    "900 grams",
    "SE Australia",
    "yellow-tailed-cockatoo.jpg",
    "yellow-tailed-cockatoo-icon.png",
    false
)
